...
SRC_FILES   =   main.c map_init.c parsing.c parsing_syntax.c parsing_utils.c clean.c mlx_config.c init_player.c raycasting.c game_loop.c control_key.c player_mouvement.c raycasting_texture.c
