...
SRCS		= main.c game.c player_movement.c mlx_utils.c
SRCS		:= $(addprefix $(SRC_DIR)/, $(SRCS) $(MAP_SRCS) $(WINDOWS_SRCS) $(CLEAN_SRCS) $(DRAWING_SRCS) $(RAYCAST_SRCS))

vpath %.c $(SRC_DIR) $(SRC_DIR)/$(MAP_DIR) $(SRC_DIR)/$(WINDOWS_DIR) $(SRC_DIR)/$(CLEAN_DIR) $(SRC_DIR)/$(DRAWING_DIR) $(SRC_DIR)/$(RAYCAST_DIR)
vpath %.h $(INC_DIR)